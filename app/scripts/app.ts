  ...
  .config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      ...
      .state('issues', {
        parent: 'repository',
        url: '/issues',
        template: `<repository-issues [issues]="ctrl.issues" [repository]="ctrl.repository"></repository-issues>`,
      ...
      .state('edit', {
        parent: 'repository',
        url: '/edit',
        template: `<repository-edit [repository]="ctrl.repository"></repository-edit>`,
        controllerAs: 'ctrl',
